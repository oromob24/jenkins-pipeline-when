pipeline {
    ...
    stages {
        ...
        stage('Create the Apache container') {
            ...
            sh 'docker run -dit --name app-web -p 9100:80  -v /Users/orlando/jenkins/app-web:/usr/local/apache2/htdocs/ httpd'
            }
        }
        //Nginx webserver
        stage('Create the Nginx container') {
            ...
            steps {
            echo 'Creating the container...'
            sh 'docker run -dit --name app-web -p 9100:80  -v //Users/orlando/jenkins/app-web:/usr/share/nginx/html nginx'
